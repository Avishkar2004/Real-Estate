          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 ">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <input
                ...
                placeholder="Phone"
              />
              <textarea className="border border-r-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400" placeholder="Message"
              ...
              <div className="flex gap-x-2">
                ...
                <button className="border border-violet-700 text-violet-700 hover:bg-violet-500 rounded p-4 text-sm w-full transition">Call</button>
              </div>
            </form>
          </div>
        </div>
